...
export const WILAYAS: WilayaOption[] = [
  ...
  { code: "59", nameAr: "أفلو", nameFr: "Aflou" },
  { code: "60", nameAr: "بريكة", nameFr: "Brikcha / Barika" },
  { code: "61", nameAr: "القنطرة", nameFr: "El-Qantara" },
  { code: "62", nameAr: "بئر العاتر", nameFr: "Bir El Ater" },
  { code: "63", nameAr: "العريشة", nameFr: "El Aricha" },
  { code: "64", nameAr: "قصر البخاري", nameFr: "Ksar el-Boukhari" },
  { code: "65", nameAr: "مسعد", nameFr: "Messaad" },
  { code: "66", nameAr: "عين وسارة", nameFr: "Ain Oussara" },
  { code: "67", nameAr: "بوسعادة", nameFr: "Boussaada" },
  { code: "68", nameAr: "البيض سيدي الشيخ", nameFr: "El-Bayadh Sidi Cheikh" },
  { code: "69", nameAr: "قصر الشلالة", nameFr: "Ksar el-Chellala" },
];
