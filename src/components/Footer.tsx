...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/classimoChaussures',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'TikTok',
      url: 'https://www.tiktok.com/@_classimo?is_from_webapp=1&sender_device=pc',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Google Maps',
      url: 'https://maps.app.goo.gl/X89Pz6CaDge3TKNq6',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-secondary/80 hover:bg-primary hover:text-primary-foreground flex items-center justify-center text-muted-foreground transition-all duration-300 hover:scale-110"
