        ...
        <div className="px-4 md:px-6">
          <div className="grid grid-cols-3 items-center h-14 md:h-16">
            ...
            <Link to="/" className="flex items-center justify-center gap-2 md:gap-3 group">
              <motion.div
                className={`w-9 h-9 md:w-11 md:h-11 rounded-full overflow-hidden border-2 transition-all duration-300 ${scrolled ? 'border-primary' : 'border-primary/60'
                  ...
                  {navLinks.map((link, index) => (
                    ...
                    >
                      <Link
                        ...
                        className={`block px-4 py-3 rounded-xl transition-all duration-300 text-center font-medium ${isActive(link.path)
